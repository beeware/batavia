...
function _validateInput(args, kwargs) {
    ...
    if (kwargs !== undefined) {
        if (kwargs['iterable'] !== undefined) {
            throw new TypeError.$pyclass("'iterable' is an invalid keyword argument for this function")
        }
        ...
        if (kwargs['key'] !== undefined) {
            ...
            throw new NotImplementedError.$pyclass('Builtin Batavia sorted function "key" function is not implemented.')
    ...
    if (args === undefined || args.length === 0) {
        throw new TypeError.$pyclass("Required argument 'iterable' (pos 1) not found")
    }
...
export default function sorted(args, kwargs) {
    ...
    throw new NotImplementedError.$pyclass("Builtin Batavia function 'sorted' not implemented for objects")
}
