...
module.exports = {
    builtins: function() {
        ...
        builtins.compile = function(args, kwargs) {
            ...
            if (ast_check == 0) {
                // this is a string
                return batavia.modules._compile.compile_string_object(source, filename, start[compile_mode], cf, false);
            }
            // parse the AST
            ...
            return batavia.modules._compile.ast_compile_object(mod, filename, cf, false);
        };
        ...
        builtins.None = new batavia.types.NoneType();
        builtins.NotImplemented = new batavia.types.NotImplementedType();
