var pytypes = require('../types/Type');
...
module.exports = function() {
    ...
    BaseException.__class__ = new pytypes.Type('BaseException', [pytypes.Object]);
    ...
    SystemExit.__class__ = new pytypes.Type('SystemExit', [BaseException]);
    ...
    KeyboardInterrupt.__class__ = new pytypes.Type('KeyboardInterrupt', [BaseException]);
    ...
    GeneratorExit.__class__ = new pytypes.Type('GeneratorExit', [BaseException]);
    ...
    Exception.__class__ = new pytypes.Type('Exception', [BaseException]);
    ...
    BataviaError.__class__ = new pytypes.Type('BataviaError', [Exception]);
    ...
    ArithmeticError.__class__ = new pytypes.Type('ArithmeticError', [Exception]);
    ...
    AssertionError.__class__ = new pytypes.Type('AssertionError', [Exception]);
    ...
    AttributeError.__class__ = new pytypes.Type('AttributeError', [Exception]);
    ...
    BufferError.__class__ = new pytypes.Type('BufferError', [Exception]);
    ...
    EOFError.__class__ = new pytypes.Type('EOFError', [Exception]);
    ...
    EnvironmentError.__class__ = new pytypes.Type('EnvironmentError', [Exception]);
    ...
    FloatingPointError.__class__ = new pytypes.Type('FloatingPointError', [Exception]);
    ...
    IOError.__class__ = new pytypes.Type('IOError', [Exception]);
    ...
    ImportError.__class__ = new pytypes.Type('ImportError', [Exception]);
    ...
    IndentationError.__class__ = new pytypes.Type('IndentationError', [Exception]);
    ...
    IndexError.__class__ = new pytypes.Type('IndexError', [Exception]);
    ...
    KeyError.__class__ = new pytypes.Type('KeyError', [Exception], null, KeyError);
    ...
    LookupError.__class__ = new pytypes.Type('LookupError', [Exception]);
    ...
    MemoryError.__class__ = new pytypes.Type('MemoryError', [Exception]);
    ...
    NameError.__class__ = new pytypes.Type('NameError', [Exception]);
    ...
    NotImplementedException.__class__ = new pytypes.Type('NotImplementedException', [Exception]);
    ...
    NotImplementedError.__class__ = new pytypes.Type('NotImplementedError', [Exception]);
    ...
    OSError.__class__ = new pytypes.Type('OSError', [Exception]);
    ...
    OverflowError.__class__ = new pytypes.Type('OverflowError', [Exception]);
    ...
    PolyglotError.__class__ = new pytypes.Type('PolyglotError', [Exception]);
    ...
    ReferenceError.__class__ = new pytypes.Type('ReferenceError', [Exception]);
    ...
    RuntimeError.__class__ = new pytypes.Type('RuntimeError', [Exception]);
    ...
    StandardError.__class__ = new pytypes.Type('StandardError', [Exception]);
    ...
    StopIteration.__class__ = new pytypes.Type('StopIteration', [Exception]);
    ...
    SyntaxError.__class__ = new pytypes.Type('SyntaxError', [Exception]);
    ...
    SystemError.__class__ = new pytypes.Type('SystemError', [Exception]);
    ...
    TabError.__class__ = new pytypes.Type('TabError', [Exception]);
    ...
    TypeError.__class__ = new pytypes.Type('TypeError', [Exception]);
    ...
    UnboundLocalError.__class__ = new pytypes.Type('UnboundLocalError', [Exception]);
    ...
    UnicodeDecodeError.__class__ = new pytypes.Type('UnicodeDecodeError', [Exception]);
    ...
    UnicodeEncodeError.__class__ = new pytypes.Type('UnicodeEncodeError', [Exception]);
    ...
    UnicodeError.__class__ = new pytypes.Type('UnicodeError', [Exception]);
    ...
    UnicodeTranslateError.__class__ = new pytypes.Type('UnicodeTranslateError', [Exception]);
    ...
    ValueError.__class__ = new pytypes.Type('ValueError', [Exception]);
    ...
    ZeroDivisionError.__class__ = new pytypes.Type('ZeroDivisionError', [Exception]);
