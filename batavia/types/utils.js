...
var do_mkvalue = function(fa) {
    for (;;) {
        switch (fa.next_char()) {
            ...
            case '[':
                throw new exceptions.NotImplementedError('do_mklist no implemented')
                // return do_mklist(fa, ']', fa.countformat(']'))

            case '{':
                throw new exceptions.NotImplementedError('do_mkdict no implemented')
            ...
            case 'C':
                return String.fromCharCode(fa.arg())
            case 's':
            case 'z':
...
var do_mktuple = function(fa, endchar, n, flags) {
    ...
    for (var i = 0; i < n; i++) {
        ...
        if (w == null) {
            throw new exceptions.NotImplementedError('do_ignore not implemented')
