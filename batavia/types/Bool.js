...
module.exports = function() {
    ...
    Boolean.prototype.__gt__ = function(other) {
        ...
        if (utils.isinstance(other, invalid_types)) {
          throw new batavia.builtins.TypeError('unorderable types: bool() > ' + utils.type_name(other) + '()');
        }
    ...
    Boolean.prototype.__pow__ = function(other) {
        if (utils.isinstance(other, batavia.types.Bool)) {
            ...
            if (this.valueOf()) {
                if (utils.isinstance(other, batavia.types.Int) && other.__ge__(new batavia.types.Float(0.0))) {
            ...
            throw new batavia.builtins.TypeError("unsupported operand type(s) for pow: 'bool' and '" + utils.type_name(other) + "'");
        }
    };
    ...
    Boolean.prototype.__floordiv__ = function(other) {
        if (utils.isinstance(other, batavia.types.Bool)) {
            ...
            throw new batavia.builtins.TypeError("unsupported operand type(s) for //: 'bool' and '" + utils.type_name(other) + "'");
        }
    };
    ...
    Boolean.prototype.__ge__ = function(other) {
        if (utils.isinstance(other, batavia.types.Float)) {
            return new batavia.types.Float((this.valueOf() ? 1.0 : 0.0) >= other.valueOf());
        } else if (utils.isinstance(other, batavia.types.Int)) {
