...
module.exports = function() {
    ...
    Boolean.prototype.__class__ = new pytypes.Type('bool');
    ...
    Boolean.prototype.__ne__ = function(other) {
        if (utils.isinstance(other, types.Str)) {
    ...
    Boolean.prototype.__gt__ = function(other) {
        ...
        if (utils.isinstance(other, invalid_types)) {
          throw new builtins.TypeError('unorderable types: bool() > ' + utils.type_name(other) + '()');
        }
    ...
    Boolean.prototype.__pow__ = function(other) {
        if (utils.isinstance(other, types.Bool)) {
        ...
        } else if (utils.isinstance(other, [types.Float, types.Int])) {
            if (this.valueOf()) {
                if (utils.isinstance(other, types.Int) && other.__ge__(new types.Float(0.0))) {
                ...
                if (other.__lt__(new types.Float(0.0))) {
                    throw new builtins.ZeroDivisionError("0.0 cannot be raised to a negative power");
            ...
            throw new builtins.TypeError("unsupported operand type(s) for pow: 'bool' and '" + utils.type_name(other) + "'");
        }
    };
    ...
    Boolean.prototype.__floordiv__ = function(other) {
        if (utils.isinstance(other, types.Bool)) {
            ...
            if (other === 0) {
                throw new builtins.ZeroDivisionError(message);
            } else if (utils.isinstance(other, types.Int)) {
            ...
            throw new builtins.TypeError("unsupported operand type(s) for //: 'bool' and '" + utils.type_name(other) + "'");
        }
    };
    ...
    Boolean.prototype.__getitem__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__getitem__ has not been implemented");
    };
    ...
    Boolean.prototype.__ge__ = function(other) {
        if (utils.isinstance(other, types.Float)) {
            return new types.Float((this.valueOf() ? 1.0 : 0.0) >= other.valueOf());
        } else if (utils.isinstance(other, types.Int)) {
    ...
    Boolean.prototype.__ifloordiv__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__ifloordiv__ has not been implemented");
    };

    Boolean.prototype.__itruediv__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__itruediv__ has not been implemented");
    };

    Boolean.prototype.__iadd__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__iadd__ has not been implemented");
    };

    Boolean.prototype.__isub__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__isub__ has not been implemented");
    };

    Boolean.prototype.__imul__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__imul__ has not been implemented");
    };

    Boolean.prototype.__imod__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__imod__ has not been implemented");
    };

    Boolean.prototype.__ipow__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__ipow__ has not been implemented");
    };

    Boolean.prototype.__ilshift__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__ilshift__ has not been implemented");
    };

    Boolean.prototype.__irshift__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__irshift__ has not been implemented");
    };

    Boolean.prototype.__iand__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__iand__ has not been implemented");
    };

    Boolean.prototype.__ixor__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__ixor__ has not been implemented");
    };

    Boolean.prototype.__ior__ = function(other) {
        throw new builtins.NotImplementedError("Boolean.__ior__ has not been implemented");
    };
