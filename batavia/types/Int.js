...
module.exports = {
    Int: function() {
        ...
        Int.prototype.__eq__ = function(other) {
            if (batavia.isinstance(other, [types.Float, types.Int])) {
        ...
        Int.prototype.__floordiv__ = function(other) {
            ...
            } else if (batavia.isinstance(other, types.Complex)) {
        ...
        Int.prototype.__mul__ = function(other) {
            if (batavia.isinstance(other, types.Int)) {
            ...
            } else if (batavia.isinstance(other, types.List)) {
                if (this.val.gt(MAX_INT.val) || this.val.lt(MIN_INT.val)) {
                ...
                return result;
            } else if (batavia.isinstance(other, types.Str)) {
                if (this.val.gt(MAX_INT.val) || this.val.lt(MIN_INT.val)) {
                    throw new batavia.builtins.OverflowError("cannot fit 'int' into an index-sized integer");
                }
                ...
                return result;
            } else if (batavia.isinstance(other, types.Tuple)) {
                if (this.val.gt(MAX_INT.val) || this.val.lt(MIN_INT.val)) {
                    throw new batavia.builtins.OverflowError("cannot fit 'int' into an index-sized integer");
                }
                if ((other.length == 0) || (this.valueOf() < 0)) {
