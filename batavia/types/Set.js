...
module.exports = function() {
    ...
    Set.prototype.__class__ = new types.Type('set');
    ...
    Set.prototype.__lt__ = function(other) {
        ...
        throw new batavia.builtins.TypeError("unorderable types: set() < " + utils.type_name(other) + "()");
    };
    ...
    Set.prototype.__pow__ = function(other) {
        throw new batavia.builtins.TypeError("unsupported operand type(s) for ** or pow(): 'set' and '" + utils.type_name(other) + "'");
    };

    Set.prototype.__div__ = function(other) {
        throw new batavia.builtins.TypeError("unsupported operand type(s) for /: 'set' and '" + utils.type_name(other) + "'");
    };
