...
module.exports = function() {
    ...
    utils['isinstance'] = function(obj, type) {
        if (type instanceof Array) {
            for (var t in type) {
                if (utils.isinstance(obj, type[t])) {
                    return true;
                }
            }
            return false;
    ...
    utils['isbataviainstance'] = function(obj) {
        return utils.isinstance(obj, [
    ...
    utils['issubclass'] = function(cls, type) {
        var t;
        if (type instanceof Array) {
            for (t in type) {
                if (utils.issubclass(cls, type[t])) {
                    return true;
                }
            }
            return false;
    ...
    utils['make_callable'] = function(func) {
        var fn = function(args, kwargs, locals) {
            ...
            if (func.__code__.co_flags & batavia.modules.dis.CO_GENERATOR) {
                gen = new batavia.types.Generator(frame, this);
                frame.generator = gen;
                retval = gen;
            } else {
    ...
    utils['iter_for_each'] = function(iterobj, callback) {
        try {
            while (true) {
