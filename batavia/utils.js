...
module.exports = function() {
    ...
    var exports = {
        ...
        'isbataviainstance': function(obj) {
         ...
         *************************************************************************/
        '_substitute': function(format, args) {
            var results = [];
        ...
        'make_class': function(args, kwargs) {
            var func = args[0];
            var name = args[1];
        ...
        'run_callable': function(self, func, posargs, namedargs) {
        ...
        'iter_for_each': function(iterobj, callback) {
            try {
                while (true) {
    ...
    exports['MAX_FLOAT'] = new Int("");
