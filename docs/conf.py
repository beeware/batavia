# -*- coding: utf-8 -*-
#
# Batavia documentation build configuration file, created by
...
# of the sidebar.
html_logo = "_static/images/batavia.png"
...
latex_documents = [
  ('index', 'batavia.tex', u'Batavia Documentation',
...
man_pages = [
    ('index', 'batavia', u'Batavia Documentation',
...
texinfo_documents = [
  ('index', 'batavia', u'Batavia Documentation',
   u'Russell Keith-Magee', 'Batavia', 'Tools to run Python bytecode on other bytecode platforms.',
   'Miscellaneous'),
]
