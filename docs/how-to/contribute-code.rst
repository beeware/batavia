...
<contribute-docs.html>`__ just for you.

Do the tutorial first!
----------------------

Before you make your first contribution, take Batavia for a spin. The
instructions in the `getting started guide <../tutorial/tutorial-0.html>`__ *should*
...
development <development-env.html>`__. The Batavia development environment is very
